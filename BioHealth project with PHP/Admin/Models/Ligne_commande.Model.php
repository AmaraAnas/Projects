...
class Ligne_commande extends Model
{
    ...
    public function add(){
        $rqt = 'INSERT INTO ligne_commande (quantite,commande_id,produit_id,prix_unitaire)
 VALUES ("'.$this->quantite.'","'.$this->commande_id .'","'.$this->produit_id.'","'.$this->prix_unitaire.'")';
        mysql_query($rqt);
    }
    ...
    public function Produits_commandes($id){
        $tab = array();
        $rqt = mysql_query("SELECT * FROM ligne_commande  WHERE commande_id=".$id);
