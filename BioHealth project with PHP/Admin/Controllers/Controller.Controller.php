...
include(dirname(__FILE__).'/../Models/Admin.Model.php');
include(dirname(__FILE__).'/../Models/Categorie.Model.php');
include(dirname(__FILE__).'/../Models/Cfp.Model.php');
include(dirname(__FILE__).'/../Models/Client.Model.php');
include(dirname(__FILE__).'/../Models/Ligne_commande.Model.php');
include(dirname(__FILE__).'/../Models/Pays.Model.php');
include(dirname(__FILE__).'/../Models/Ville.Model.php');
include(dirname(__FILE__).'/../Models/Prod_details.Model.php');
include(dirname(__FILE__).'/../Models/Photo.Model.php');
include(dirname(__FILE__).'/../Models/Langue.Model.php');
